...
namespace RegexToDFA.Automata
{
    internal class NondeterministicFiniteAutomaton
    {
        ...
        public Dictionary<string, Dictionary<char, HashSet<string>>> Delta
        { get; } = new Dictionary<string, Dictionary<char, HashSet<string>>>();
        ...
        public static NondeterministicFiniteAutomaton Merge(
            NondeterministicFiniteAutomaton A,
            NondeterministicFiniteAutomaton B)
        {
            ...
            foreach (var c in A.Sigma)
                C.AddSymbol(c);

            foreach (var c in B.Sigma)
                C.AddSymbol(c);
